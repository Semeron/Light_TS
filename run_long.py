...
parser = argparse.ArgumentParser(description='LightTS on ETT dataset')
...
parser.add_argument('--seq_len', type=int, default=96, help='input sequence length of LightTS, look back window')
...
seeds = [4321, 1234, 1, 255, 1023]

if args.evaluate:
    setting = '{}_{}_ft{}_sl{}_pl{}_lr{}_bs{}_itr0'.format(args.model_name,args.data, args.features, args.seq_len, args.pred_len,args.lr,args.batch_size)
    ...
    if args.itr:
        for ii in range(len(seeds)):
            ...
            setting = '{}_{}_ft{}_sl{}_pl{}_lr{}_bs{}_seed{}'.format(args.model_name,args.data, args.features, args.seq_len, args.pred_len,args.lr,args.batch_size,seed)
        ...
        setting = '{}_{}_ft{}_sl{}_pl{}_lr{}_bs{}'.format(args.model_name,args.data, args.features, args.seq_len, args.pred_len,args.lr,args.batch_size)
