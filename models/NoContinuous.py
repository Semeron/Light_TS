...
class NoContinuousLayer(nn.Module):
    def __init__(self, input_dim, hid_dim, output_dim, num_node, c_dim=None):
        super(NoContinuousLayer, self).__init__()
...
class NoContinuous(nn.Module):
    ...
    def _build(self):
        self.layer_1 = NoContinuousLayer(
        ...
        self.layer_2 = NoContinuousLayer(
            input_dim=self.chunk_size,
            hid_dim=self.hid_dim // 4,
            output_dim=self.hid_dim // 4,
            num_node=self.num_chunks
        ...
        self.layer_3 = NoContinuousLayer(
